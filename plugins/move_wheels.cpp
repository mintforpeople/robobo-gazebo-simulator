...
void MoveWheels::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
  ...
  model->GetJoint("left_motor")->SetLowerLimit(0, 1*M_PI/180);
  model->GetJoint("left_motor")->SetUpperLimit(0, 1*M_PI/180);
  model->GetJoint("right_motor")->SetPosition(0, 1*M_PI/180);
  model->GetJoint("right_motor")->SetLowerLimit(0, 1*M_PI/180);
  model->GetJoint("right_motor")->SetUpperLimit(0, 1*M_PI/180);
...
void MoveWheels::HandleMoveWheels(int8_t lwp, int8_t rwp, float time, int16_t blockid)
{
  ...
  model->GetJoint("left_motor")->SetLowerLimit(0,-9E16);
  model->GetJoint("left_motor")->SetUpperLimit(0,9E16);
  model->GetJoint("right_motor")->SetLowerLimit(0,-9E16);
  model->GetJoint("right_motor")->SetUpperLimit(0,9E16);
...
// Calculate joints target velocity
  ...
  model->GetJoint("left_motor")->SetLowerLimit(0, model->GetJoint("left_motor")->Position(0));
  model->GetJoint("left_motor")->SetUpperLimit(0, model->GetJoint("left_motor")->Position(0));
  model->GetJoint("right_motor")->SetLowerLimit(0, model->GetJoint("right_motor")->Position(0));
  model->GetJoint("right_motor")->SetUpperLimit(0, model->GetJoint("right_motor")->Position(0));
